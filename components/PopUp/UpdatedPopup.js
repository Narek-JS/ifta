    ...
    return (
        <div className='updatedPopup'>
            ...
            <p className="content">
                ...
                In order to enhance your experience with <Link href='/'>IFTA.Online</Link>, we have made significant updates to our platform. If you need any assistance, please feel free to reach out to us! In the meantime, we invite you to explore our newly updated website. Thank you!
            </p>
