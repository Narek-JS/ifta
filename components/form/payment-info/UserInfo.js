...
export default function UserInfo ({ formik, data, condition, setCondition }) {
    const sigRef = useRef();
    const dispatch = useDispatch();
    const { width } = useWindowSize();

    // Memoized properties for the signature canvas.
    ...
    // Handle the end of signature drawing, updating formik values.
    ...
    // Clear the signature from the canvas and formik values.
    ...
    // Handle changes in the initial input fields.
    ...
    // Open the terms and conditions popup.
            ...
            <div className="userInfoArea">
               ...
               <div className="initialItem mb15 flex gap25">
                    ...
                    <p className="initialRule primary60">
                        ...
                        Submitting false information could result in penalties and fines.
                        It is a federal crime to submit false information in an attempt to commit fraud.
                        I hereby authorize the collection of payment for all charges as indicated above.
                        I acknowledge that charges may not exceed the total amount listed under the “TOTAL COST” field.
                        I understand that this authorization is only in effect during the time period of this transaction.
                        If any additional charges are to need authorization, a new authorization form will have to be completed.
                    </p>
                </div>
               <div className="initialItem mb15 flex gap25">
                    <InputField
                    ...
                    />
                    <p className="initialRule primary60">
                        I acknowledge that the total amount of today’s transaction,
                        indicated under the “TOTAL COST” field includes any and all Federal, State, and Local Government fees. 
                    </p>
               </div>
               <div className="initialItem mb20 flex gap25">
                    ...
                    />
                    <p className="initialRule primary60">
                        I hereby acknowledge and agree that after the charges are authorized,
                        an IFTA Online agent will be assigned within 15 minutes to run the order.
                        Once the agent has been assigned, the charges become non-refundable.
                    </p>
               </div>
                <div className="orderCreator flexBetween gap20">
                    ...
                    <div className="userDataItem flexColumn flexBetween alignCenter font14 weight500 line24">
                        ...
                        <p className="primary80">{ dateSigned }</p>
                        <span />
                    </div>
                ...
                <div className="flexColumn mt20 gap10">
                    <div className="conditions flex alignEnd gap5 line24">
                        ...
                        <p className="lighthouse-black pointer underline size14-mb" onClick={openTermsPopup}> Terms and Conditions </p>
                    </div>
                </div>
           </div>
       </div>
