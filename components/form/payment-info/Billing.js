...
class GetNewValues {
    constructor (address = '', city = '', state = '', zip_code = '', states) {
        ...
        this.city = city;
        this.state = state ? states.find(item => item.app === state) || state : state;
    ...
    return (
        <>
            ...
            <form className="flexColumn alignCenter gap20 mb20 mt20">
                <div className="flex gap20 alignCenter radioGroup">
                ...
                <div className="flexBetween formSection gap20 alignCenter mb20 w100">
                    <InputField
                        ...
                        disabled={checboxTypes.phisicalAddress}
