        ...
        <>
            ...
            <div className='d-flex justify-between switch-field'>
                ...
                <div>
                    ...
                    <p className='primary60 smaller-text'>If selected, you’ll be able to use this
            ...
            <div className='d-flex justify-center'>
                <p className='primary60 desc'>Your phone number helps us keep your account secure by adding an
                    additional layer of verification.</p>
            </div>

            <div className='btn-field'>
                <Button className='outlined secondary' type='button' onClick={() => setStep(2)}>Add phone
                    number</Button>
            </div>
        </>
    );
