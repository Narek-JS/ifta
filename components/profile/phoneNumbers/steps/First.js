            ...
            <div className={`nth-box phone-box step${step}`}>
                ...
                <div>
                    ...
                    <div className='phone-field'>
                        <p className='primary'>{phoneNumber ? phoneNumber : '(999) 999 999 9999'}</p>
                        <p className='primary60'>Use for resetting password</p>
                    </div>
                </div>
                <div className='btn-field'>
                    <p className='primary60 desc'>Your phone number helps us keep your
                        account secure by adding an additional
                        layer of verification.</p>
                    <div className="flexCenter">
                        <NormalBtn className='outlined secondary' type='button' onClick={() => setStep(2)}>Update phone
                            number
                        </NormalBtn>
                    </div>
                </div>
