...
export default function SignUp() {
            ...
            dispatch(userRegister({
                ...
                password_confirmation: values.passwordConfirm
                    ...
                    if (res.payload?.action) {
                        // Show success popup and Navigate to the home page.
    ...
    // Effect to set form values from local storage.
    useEffect(() => {
        ...
        <div className="authForm loginForm">
            ...
            <div className="authFormEnding flexColumn gap20 alignCenter pb20">
                <span className="primary60 terms">
                    ...
                    <span className="lighthouse-black underline pointer" onClick={openTermsPopup}>
            ...
            <p className="primary60 mt20 textCenter">
                ...
                <Link href="/sign-in" className="lighthouse-black underline">
                    Log in here
                </Link>
            </p>
        </div>
