export const ClosePopupIcon = ({ onClick = () => {}, style = {} }) => (
    <svg style={style} onClick={onClick} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
